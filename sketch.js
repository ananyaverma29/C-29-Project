...
function setup() {
  ...
  leftWall = new Base(300, height / 2 + 50, 500, 100, "#8d6e63", true);
  rightWall = new Base(width - 300, height / 2 + 50, 500, 100, "#8d6e63", true);
...
/*  bridge = new Base(15, { x: width / 2 - 400, y: height / 2 });
  ...
  jointPoint = new Base(width - 550, height / 2 + 20, 40, 20, "#8d6e63", true);
